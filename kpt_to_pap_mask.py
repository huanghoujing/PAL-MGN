...
PARTS_DICT = {
    'PAP_2P': ('UPPER_HALF', 'LOWER_HALF'),
    'PAP_3P': ('THIRD1', 'THIRD2', 'THIRD3'),
...
def gen_pap_masks(im_h_w, h_w, kpts, mask_type='PAP_9P'):
    ...
    def _gen_THIRD1_mask():
        return _gen_mask(0, shoulder_hip_mid_y, shoulder_hip_mid_v, part_name='THIRD1')

    def _gen_THIRD2_mask():
        return _gen_mask(shoulder_hip_mid_y, knee_y, shoulder_hip_mid_v and knee_v, part_name='THIRD2')

    def _gen_THIRD3_mask():
        return _gen_mask(knee_y, H, knee_v, part_name='THIRD3')
